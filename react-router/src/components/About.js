...
export default function About() {
    return (
        <div className="aboutpage">
            ...
            <p>When returning from a spiritual journey through the Earth, Monty McMansions decided to dedicate some of his fortune to offering spiritual wellness for others back in his hometown. </p>
